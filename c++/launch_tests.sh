...
PROBLEM_FILES="src/Utilities.cpp src/Tonality.cpp src/MajorTonality.cpp \
                ...
                src/Solver.cpp src/MidiFileGeneration.cpp src/BranchingTests.cpp"
...
outFileOpt="results/stats/search-stats-${currentDate}.csv"  # filename of the results (with the date at the end of the file)
...
cat $inputFile | parallel --colsep '|' ./$cpp_executable {1} {2} {3} {4} {5} >> $outFileOpt
