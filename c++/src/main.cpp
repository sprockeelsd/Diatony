...
int main(int argc, char* argv[]) {
    ...
    vector<int> chords = {FIRST_DEGREE, FLAT_TWO, FIFTH_DEGREE, FIRST_DEGREE};
    ...
    vector<int> states = {FUNDAMENTAL_STATE, FIRST_INVERSION, FUNDAMENTAL_STATE, FUNDAMENTAL_STATE};
