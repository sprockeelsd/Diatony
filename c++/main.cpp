...
//                          FUNDAMENTAL_STATE, FUNDAMENTAL_STATE, FUNDAMENTAL_STATE, SECOND_INVERSION, FUNDAMENTAL_STATE, FUNDAMENTAL_STATE};
    vector<int> chords = {SIXTH_DEGREE, FIRST_DEGREE};//, FIRST_DEGREE, FIFTH_DEGREE, FIRST_DEGREE};//, FOURTH_DEGREE, THIRD_DEGREE, FOURTH_DEGREE, FIFTH_DEGREE, FIRST_DEGREE};
    vector<int> states = {FUNDAMENTAL_STATE, SECOND_INVERSION};//, SECOND_INVERSION, FUNDAMENTAL_STATE, FUNDAMENTAL_STATE};
